...
{
  EUSCI_A__UCACTLW0_REG_s UCACTLW0; /* Offset: 0x0 */
  ...
  EUSCI_A__UCASTATW_REG_s UCASTATW; /* Offset: 0xa */
  EUSCI_A__UCASTATW_SPI_REG_s UCASTATW_SPI; /* Offset: 0xa */
  EUSCI_A__UCARXBUF_REG_s UCARXBUF; /* Offset: 0xc */
  EUSCI_A__UCARXBUF_SPI_REG_s UCARXBUF_SPI; /* Offset: 0xc */
  EUSCI_A__UCATXBUF_REG_s UCATXBUF; /* Offset: 0xe */
  ...
  uint8_t RESERVED1[6];
  EUSCI_A__UCAIE_REG_s UCAIE; /* Offset: 0x1a */
  EUSCI_A__UCAIE_SPI_REG_s UCAIE_SPI; /* Offset: 0x1a */
  EUSCI_A__UCAIFG_REG_s UCAIFG; /* Offset: 0x1c */
